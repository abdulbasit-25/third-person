...
| P0-03 | P0       | Data integrity | Concurrent review submissions can create duplicate versions/current-state problems | 🔴 UNSOLVED         | `app/api/reviews/route.ts`, DB indexes                          | —                                                                        | Fix transaction/version allocation and enforce DB constraints.                                                                                 |
...
| P0-05 | P0       | Testing        | No automated test suite                                                            | 🔴 UNSOLVED         | Project-wide                                                    | —                                                                        | Add tests for authentication, ownership, review versioning, validation, and critical APIs.                                                     |
| P1-01 | P1       | Security       | Login has no brute-force/rate-limit protection                                     | 🔴 UNSOLVED         | `app/api/auth/login/route.ts`                                   | —                                                                        | Protect reviewer and admin login.                                                                                                              |
| P1-02 | P1       | Security       | Admin login has no brute-force/rate-limit protection                               | 🔴 UNSOLVED         | `app/api/auth/admin-login/route.ts`                             | —                                                                        | Protect administrator authentication.                                                                                                          |
...
| P2-03 | P2       | Admin          | Review detail experience is shallow                                                | 🔴 UNSOLVED         | Dashboard review/archive pages                                  | —                                                                        | Add full review detail view.                                                                                                                   |
| P2-04 | P2       | Admin          | Reviewer profiles/context are limited                                              | 🔴 UNSOLVED         | People/dashboard                                                | —                                                                        | Improve reviewer overview without exposing unnecessary data.                                                                                   |
